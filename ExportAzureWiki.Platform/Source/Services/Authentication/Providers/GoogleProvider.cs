...
{
    public class GoogleProvider : BaseAuthenticationProvider
    {
        ...
        public override AuthenticationProvider ProviderType => AuthenticationProvider.Google;
        public override string ProviderName => "Google";

        public GoogleProvider(Dictionary<string, string> config) : base(config)
        {
        }
        ...
        public override async Task<AuthenticationResult> AuthenticateAsync(Dictionary<string, string>? parameters = null)
        {
            try
            {
                ...
                if (string.IsNullOrEmpty(clientId) || string.IsNullOrEmpty(clientSecret))
                {
                    ...
                    {
                        Success = false,
                        ErrorMessage = LocalizationManager.S("auth.provider.google.not_configured")
                    };
                }
            ...
            catch (Exception ex)
            {
                ...
                {
                    Success = false,
                    ErrorMessage = LocalizationManager.Sf("auth.provider.google.auth_failed", ex.Message)
                };
            }
        }
